  ...
  tableRules: [
    {
      ...
      rowAnchorLabels: ["nr.", "no.", "menge", "quantity", "einheit", "unit", "rohstoff", "ingredient"],
      columns: [
        { id: "nr",       label: "Nr.",       anchorLabels: ["nr.", "no."] },
        { id: "rohstoff", label: "Rohstoff",  anchorLabels: ["rohstoff", "bezeichnung", "ingredient", "komponente", "raw material"] },
    ...
    },
    {
      ...
      rowAnchorLabels: ["nr.", "no.", "menge", "quantity", "rohstoff", "ingredient"],
      columns: [
        { id: "nr",       label: "Nr.",       anchorLabels: ["nr.", "no."] },
        { id: "rohstoff", label: "Rohstoff",  anchorLabels: ["rohstoff", "bezeichnung", "ingredient", "komponente", "raw material"] },
        { id: "menge",    label: "Menge",     anchorLabels: ["menge", "quantity"] },
